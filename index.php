...
?>
    ...
    <div id="content">
        <div id="bg" class=" ">
            ...
            <h1>We support local :)</h1>
            <p> 40% OFF on first purchase </p>
        ...
        <div class="row text-center ">
            ...
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#headphones">
                 <img src="https://i.pinimg.com/736x/1e/f5/22/1ef522dc00fd69c5647aae5d5705a760.jpg" class="img-fluid  " alt="" style="border-radius:0.5rem">
                 <div class="h5 pt-3 font-weight-bolder">
                    Women
                 </div>
              </div>
