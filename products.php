...
<head>
    ...
    <title>MauriShop | Online Shopping Site Mauritian</title>
...
<div class="container" style="margin-top:65px">
    ...
    <div class="row text-center" id="shirt">
        ...
        <div class="row text-center" id="shoes" >
            ...
            <div class="row text-center" id="Women">
                    <div class="col-md-3 col-6 py-3" >
                        <div class="card">
                            <img src="https://i.pinimg.com/originals/f6/c8/c0/f6c8c0b8b4e21a381722d264bf0848d6.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Cute Yellow Sundress</h6>
                                <h6>Price :Rs 2200</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="https://i.pinimg.com/474x/84/4a/8c/844a8c32a09652786169503ca7606e94.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Little black dress</h6>
                                <h6>Price :Rs 800</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="https://i.pinimg.com/originals/61/62/61/616261927bc4479e07b9e51a78fce8f4.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Red Dress for tonight</h6>
                                <h6>Price :Rs 1000</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                   ...
                   <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="https://i.pinimg.com/474x/b3/54/67/b35467adb666aa18f889536bd1837269.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Sari Fit for a goddess</h6>
